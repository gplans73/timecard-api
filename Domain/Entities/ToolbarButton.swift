...
struct ToolbarButtonsSettingsView: View {
    ...
    var body: some View {
        List {
            ...
            Section(footer: Text("These buttons will appear in the job code input toolbar. Tap a button to quickly insert its code.")) {
                EmptyView()
            }
        }
    ...
    private func addButton() {
        let newButton = ToolbarButton(title: "New", code: "")
